...
//                 </ul>
//             </div>
//             <div className="navbar-end mx-2 space-x-2">
//                 <NavLink to="login" className="hover:text-blue-500 btn btn-outline btn-primary">Login</NavLink>
//                 {/* <a className="btn btn-outline btn-primary">Login</a> */}
//                 <NavLink to="register" className="hover:text-blue-500 btn btn-outline btn-primary">Register</NavLink>
    ...
    <div className="navbar bg-base-100 shadow-lg">
      ...
      <div className="navbar-start">
        ...
        {/* <Link to="/" className="btn btn-ghost text-xl flex items-center gap-2">
          <img src="https://i.ibb.co/ZpxW9pT9/textile-img.jpg" alt="Textile Art Logo" className="h-8 w-8 rounded-full" />
          Textile Art
        </Link> */}
      </div>
